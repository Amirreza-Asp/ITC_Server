...
{
    public class AddPracticalActionIndicatorCommand : IRequest<CommandResponse>
    {
        [Required]
    ...
    public class AddPracticalActionIndicatorCommandHandler : IRequestHandler<AddPracticalActionIndicatorCommand, CommandResponse>
    {
        private readonly ApplicationDbContext _context;

        public AddPracticalActionIndicatorCommandHandler(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<CommandResponse> Handle(AddPracticalActionIndicatorCommand request, CancellationToken cancellationToken)
        {
            ...
            var inp = new PracticalActionIndicator { IndicatorId = indicator.Id, PracticalActionId = request.PracticalActionId };

            _context.Indicators.Add(indicator);
            _context.PracticalActionIndicators.Add(inp);
